...
def test_deployment_absent_valid():
    c=TemplateEngine().resolve('SBM-Agent-Template','2.0.1',TEMPLATE,CFG['canonical_template_sha256']); assert 'deployment' in c.optional_file_groups; c.close()
