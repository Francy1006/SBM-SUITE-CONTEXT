...
def test_wrong_standard_version(tmp_path):
    b=write_fixture_bundle(tmp_path/'i',TEMPLATE,agent_id='V'); s=yaml.safe_load(b['spec'].read_text()); s['standard_version']='9.0.0'; b['spec'].write_text(yaml.safe_dump(s,sort_keys=False))
