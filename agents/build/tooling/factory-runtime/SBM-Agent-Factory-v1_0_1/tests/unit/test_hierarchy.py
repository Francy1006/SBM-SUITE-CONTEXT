...
from sbm_agent_factory.hierarchy import validate_hierarchy
def test_hierarchy(): assert validate_hierarchy({'agent_id':'A','hierarchy_version':'1','reports_to':'B','can_request_from':[],'can_instruct':[],'requires_approval_from':[],'escalation_target':'B'})
