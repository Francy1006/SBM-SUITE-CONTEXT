...
| ADR-036 | 2026-08-16 | superseded | Use an intermediate integration branch with type-specific promotion paths | Direct-to-main objective branches needed controlled integration and release boundaries | Direct main integration; ad-hoc branches | Superseded by ADR-041 after the intermediate branch added lifecycle complexity and contradictory paths | All Git repositories | DevOps / Context |
